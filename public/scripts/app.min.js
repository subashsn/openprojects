/*OpenProjects (Beta) - Aman Sardana. CSI - VIT, 2015.
This file contains all the Core JS (plugins except initialization) + Custom Code.*/
...
! function (global, factory) {
	...
	ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || [], jQuery.extend({
		...
		ajax: function (url, options) {
			...
			if (deferred.promise(jqXHR).complete = completeDeferred.add, jqXHR.success = jqXHR.done, jqXHR.error = jqXHR.fail, s.url = ((url || s.url || ajaxLocation) + "").replace(rhash, "").replace(rprotocol, ajaxLocParts[1] + "//"), s.type = options.method || options.type || s.method || s.type, s.dataTypes = jQuery.trim(s.dataType || "*").toLowerCase().match(rnotwhite) || [""],
...
! function e(t, n, r) {
	...
	1: [function (require, module, exports) {
		...
		function mountJQuery(jQuery) {
			jQuery.fn.perfectScrollbar = function (settingOrCommand) {
				return this.each(function () {
					if ("object" == typeof settingOrCommand || "undefined" == typeof settingOrCommand) {
		...
		if ("function" == typeof define && define.amd) define(["jquery"], mountJQuery);
			...
			"undefined" != typeof jq && mountJQuery(jq)
		}
	...
	3: [function (require, module, exports) {
		...
		DOM.e = function (tagName, className) {
			...
			return "object" == typeof styleNameOrObject ? cssMultiSet(element, styleNameOrObject) : "undefined" == typeof styleValue ? cssGet(element, styleNameOrObject) : cssSet(element, styleNameOrObject, styleValue)
			...
			"undefined" != typeof element.remove ? element.remove() : element.parentNode && element.parentNode.removeChild(element)
	...
	4: [function (require, module, exports) {
		...
		EventElement.prototype.bind = function (eventName, handler) {
			"undefined" == typeof this.events[eventName] && (this.events[eventName] = []), this.events[eventName].push(handler), this.element.addEventListener(eventName, handler, !1)
		}, EventElement.prototype.unbind = function (eventName, handler) {
			var isHandlerProvided = "undefined" != typeof handler;
			this.events[eventName] = this.events[eventName].filter(function (hdlr) {
				return isHandlerProvided && hdlr !== handler ? !0 : (this.element.removeEventListener(eventName, hdlr, !1), !1)
			}, this)
		...
		EventManager.prototype.eventElement = function (element) {
			...
			return "undefined" == typeof ee && (ee = new EventElement(element), this.eventElements.push(ee)), ee
	...
	6: [function (require, module, exports) {
		...
		exports.toInt = function (x) {
			...
			cls.add(element, "ps-in-scrolling"), "undefined" != typeof axis ? cls.add(element, "ps-" + axis) : (cls.add(element, "ps-x"), cls.add(element, "ps-y"))
		}, exports.stopScrolling = function (element, axis) {
			cls.remove(element, "ps-in-scrolling"), "undefined" != typeof axis ? cls.remove(element, "ps-" + axis) : (cls.remove(element, "ps-x"), cls.remove(element, "ps-y"))
		}, exports.env = {
		...
		function bindClickRailHandler(element, i) {
			...
			i.settings.stopPropagationOnClick && i.event.bind(i.scrollbarY, "click", stopPropagation), i.event.bind(i.scrollbarYRail, "click", function (e) {
				var halfOfScrollbarLength = h.toInt(i.scrollbarYHeight / 2),
					positionTop = i.railYRatio * (e.pageY - window.pageYOffset - pageOffset(i.scrollbarYRail).top - halfOfScrollbarLength),
					maxPositionTop = i.railYRatio * (i.railYHeight - i.scrollbarYHeight),
					positionRatio = positionTop / maxPositionTop;
				0 > positionRatio ? positionRatio = 0 : positionRatio > 1 && (positionRatio = 1), updateScroll(element, "top", (i.contentHeight - i.containerHeight) * positionRatio), updateGeometry(element), e.stopPropagation()
				...
				var halfOfScrollbarLength = h.toInt(i.scrollbarXWidth / 2),
					positionLeft = i.railXRatio * (e.pageX - window.pageXOffset - pageOffset(i.scrollbarXRail).left - halfOfScrollbarLength),
					maxPositionLeft = i.railXRatio * (i.railXWidth - i.scrollbarXWidth),
					positionRatio = positionLeft / maxPositionLeft;
				0 > positionRatio ? positionRatio = 0 : positionRatio > 1 && (positionRatio = 1), updateScroll(element, "left", (i.contentWidth - i.containerWidth) * positionRatio - i.negativeScrollAdjustment), updateGeometry(element), e.stopPropagation()
			})
		}
	...
	11: [function (require, module, exports) {
		...
		function bindMouseScrollXHandler(element, i) {
			function updateScrollLeft(deltaX) {
				...
				0 > newLeft ? i.scrollbarXLeft = 0 : newLeft > maxLeft ? i.scrollbarXLeft = maxLeft : i.scrollbarXLeft = newLeft;
		...
		function bindMouseScrollYHandler(element, i) {
			function updateScrollTop(deltaY) {
				...
				0 > newTop ? i.scrollbarYTop = 0 : newTop > maxTop ? i.scrollbarYTop = maxTop : i.scrollbarYTop = newTop;
		...
		function bindKeyboardHandler(element, i) {
			function shouldPreventDefault(deltaX, deltaY) {
				...
				if (0 === deltaX) {
					...
					if (0 === scrollTop && deltaY > 0 || scrollTop >= i.contentHeight - i.containerHeight && 0 > deltaY) return !i.settings.wheelPropagation
				}
				var scrollLeft = element.scrollLeft;
				if (0 === deltaY) {
					if (!i.scrollbarXActive) return !1;
					if (0 === scrollLeft && 0 > deltaX || scrollLeft >= i.contentWidth - i.containerWidth && deltaX > 0) return !i.settings.wheelPropagation
				}
				return !0
			}
			var hovered = !1;
			...
			i.event.bind(i.ownerDocument, "keydown", function (e) {
				if ((!e.isDefaultPrevented || !e.isDefaultPrevented()) && hovered) {
	...
	13: [function (require, module, exports) {
		...
		function bindMouseWheelHandler(element, i) {
			...
			function getDeltaFromEvent(e) {
				var deltaX = e.deltaX,
					deltaY = -1 * e.deltaY;
				return ("undefined" == typeof deltaX || "undefined" == typeof deltaY) && (deltaX = -1 * e.wheelDeltaX / 6, deltaY = e.wheelDeltaY / 6), e.deltaMode && 1 === e.deltaMode && (deltaX *= 10, deltaY *= 10), deltaX !== deltaX && deltaY !== deltaY && (deltaX = 0, deltaY = e.wheelDelta), [deltaX, deltaY]
			}
			...
			function shouldBeConsumedByTextarea(deltaX, deltaY) {
				...
				if (hoveredTextarea) {
					...
					if (maxScrollLeft > 0 && !(0 === hoveredTextarea.scrollLeft && 0 > deltaX || hoveredTextarea.scrollLeft === maxScrollLeft && deltaX > 0)) return !0
				}
				return !1
			}
		...
		function bindSelectionHandler(element, i) {
			...
			function startScrolling() {
				scrollingLoop || (scrollingLoop = setInterval(function () {
					return instances.get(element) ? (updateScroll(element, "top", element.scrollTop + scrollDiff.top), updateScroll(element, "left", element.scrollLeft + scrollDiff.left), void updateGeometry(element)) : void clearInterval(scrollingLoop)
				}, 50))
			}
			...
			i.event.bind(i.ownerDocument, "selectionchange", function () {
				...
				if (isSelected) {
					...
					mousePosition.x < containerGeometry.left + 3 ? (scrollDiff.left = -5, h.startScrolling(element, "x")) : mousePosition.x > containerGeometry.right - 3 ? (scrollDiff.left = 5, h.startScrolling(element, "x")) : scrollDiff.left = 0, mousePosition.y < containerGeometry.top + 3 ? (containerGeometry.top + 3 - mousePosition.y < 5 ? scrollDiff.top = -5 : scrollDiff.top = -20, h.startScrolling(element, "y")) : mousePosition.y > containerGeometry.bottom - 3 ? (mousePosition.y - containerGeometry.bottom + 3 < 5 ? scrollDiff.top = 5 : scrollDiff.top = 20, h.startScrolling(element, "y")) : scrollDiff.top = 0, 0 === scrollDiff.top && 0 === scrollDiff.left ? stopScrolling() : startScrolling()
				}
			})
		}
		var h = require("../../lib/helper"),
		...
		function bindTouchHandler(element, i, supportsTouch, supportsIePointer) {
			function shouldPreventDefault(deltaX, deltaY) {
				...
				if (magnitudeY > magnitudeX) {
					if (0 > deltaY && scrollTop === i.contentHeight - i.containerHeight || deltaY > 0 && 0 === scrollTop) return !i.settings.swipePropagation
				} else if (magnitudeX > magnitudeY && (0 > deltaX && scrollLeft === i.contentWidth - i.containerWidth || deltaX > 0 && 0 === scrollLeft)) return !i.settings.swipePropagation;
				return !0
			}
			...
			function touchEnd() {
				!inGlobalTouch && inLocalTouch && (inLocalTouch = !1, clearInterval(easingLoop), easingLoop = setInterval(function () {
					return instances.get(element) ? Math.abs(speed.x) < .01 && Math.abs(speed.y) < .01 ? void clearInterval(easingLoop) : (applyTouchMove(30 * speed.x, 30 * speed.y), speed.x *= .8, void(speed.y *= .8)) : void clearInterval(easingLoop)
				}, 10))
			}
			var startOffset = {},
				startTime = 0,
	...
	17: [function (require, module, exports) {
		...
		module.exports = function (element, userSettings) {
			...
			i.settings = h.extend(i.settings, userSettings), clickRailHandler(element), dragScrollbarHandler(element), mouseWheelHandler(element), nativeScrollHandler(element), i.settings.useSelectionScroll && selectionHandler(element), (h.env.supportsTouch || h.env.supportsIePointer) && touchHandler(element, h.env.supportsTouch, h.env.supportsIePointer), i.settings.useKeyboard && keyboardHandler(element), updateGeometry(element)
		}
	}, {
		"../lib/class": 2,
		"../lib/helper": 6,
	...
	18: [function (require, module, exports) {
		...
		function Instance(element) {
			var i = this;
			i.settings = h.clone(defaultSettings), i.containerWidth = null, i.containerHeight = null, i.contentWidth = null, i.contentHeight = null, i.isRtl = "rtl" === d.css(element, "direction"), i.isNegativeScroll = function () {
		...
		function getId(element) {
			return "undefined" == typeof element.dataset ? element.getAttribute("data-ps-id") : element.dataset.psId
		}

		function setId(element, id) {
			"undefined" == typeof element.dataset ? element.setAttribute("data-ps-id", id) : element.dataset.psId = id
		}

		function removeId(element) {
			"undefined" == typeof element.dataset ? element.removeAttribute("data-ps-id") : delete element.dataset.psId
		}
		var d = require("../lib/dom"),
	...
	19: [function (require, module, exports) {
		...
		module.exports = function (element) {
			...
			var existingRails;
			element.contains(i.scrollbarXRail) || (existingRails = d.queryChildren(element, ".ps-scrollbar-x-rail"), existingRails.length > 0 && existingRails.forEach(function (rail) {
				d.remove(rail)
			}), d.appendTo(i.scrollbarXRail, element)), element.contains(i.scrollbarYRail) || (existingRails = d.queryChildren(element, ".ps-scrollbar-y-rail"), existingRails.length > 0 && existingRails.forEach(function (rail) {
				d.remove(rail)
	...
	20: [function (require, module, exports) {
		...
		upEvent.initEvent("ps-scroll-up", !0, !0), downEvent.initEvent("ps-scroll-down", !0, !0), leftEvent.initEvent("ps-scroll-left", !0, !0), rightEvent.initEvent("ps-scroll-right", !0, !0), yEvent.initEvent("ps-scroll-y", !0, !0), xEvent.initEvent("ps-scroll-x", !0, !0), xStartEvent.initEvent("ps-x-reach-start", !0, !0), xEndEvent.initEvent("ps-x-reach-end", !0, !0), yStartEvent.initEvent("ps-y-reach-start", !0, !0), yEndEvent.initEvent("ps-y-reach-end", !0, !0), module.exports = function (element, axis, value) {
			if ("undefined" == typeof element) throw "You must provide an element to the update-scroll function";
			if ("undefined" == typeof axis) throw "You must provide an axis to the update-scroll function";
			if ("undefined" == typeof value) throw "You must provide a value to the update-scroll function";
			if ("top" === axis && 0 >= value) return element.scrollTop = 0, void element.dispatchEvent(yStartEvent);
			if ("left" === axis && 0 >= value) return element.scrollLeft = 0, void element.dispatchEvent(xStartEvent);
			var i = instances.get(element);
			return "top" === axis && value >= i.contentHeight - i.containerHeight ? (element.scrollTop = i.contentHeight - i.containerHeight, void element.dispatchEvent(yEndEvent)) : "left" === axis && value >= i.contentWidth - i.containerWidth ? (element.scrollLeft = i.contentWidth - i.containerWidth, void element.dispatchEvent(xEndEvent)) : (lastTop || (lastTop = element.scrollTop), lastLeft || (lastLeft = element.scrollLeft), "top" === axis && lastTop > value && element.dispatchEvent(upEvent), "top" === axis && value > lastTop && element.dispatchEvent(downEvent), "left" === axis && lastLeft > value && element.dispatchEvent(leftEvent), "left" === axis && value > lastLeft && element.dispatchEvent(rightEvent), "top" === axis && (element.scrollTop = lastTop = value, element.dispatchEvent(yEvent)), void("left" === axis && (element.scrollLeft = lastLeft = value, element.dispatchEvent(xEvent))))
		}
	}, {
		"./instances": 18
	}],
...
! function ($) {
	...
	function preloader() {
		$(window).on("load", function () {
			if ($("body > .pageload").length) {
				if ($("body").hasClass("page-loaded")) return;
				$("body").addClass("page-loaded").removeClass("page-loading"), $("body > .pageload").fadeOut()
			}
		})
	}
	...
	function apps() {
		$(".message-list .message-list-item a, .message-toolbar .icon-close").on("click", function (e) {
			e.preventDefault(), e.stopPropagation(), app.toggleClass("message-open")
		})/*, $(".contacts-list li, .contact-toolbar .icon-close").on("click", function (e) {
			e.preventDefault(), e.stopPropagation(), app.toggleClass("contact-open")
		})*/
	}

	function smallMenu() {
		$("[data-toggle=layout-small-menu]").on("click", function (e) {
			e.preventDefault(), e.stopPropagation(), app.toggleClass("layout-small-menu"), app.hasClass("layout-small-menu") ? (destroyScrollbars(), $(".quick-launch-apps").is(":visible") && $(".quick-launch-apps").addClass("hide").next().removeClass("hide")) : psTarg.hasClass("ps-container") || initScrollbars()
		})
	}

	function toggleChatSidebar() {
		isChatOpen ? app.removeClass("layout-chat-open") : app.addClass("layout-chat-open"), isChatOpen = !isChatOpen
	}
	...
	function chatPanel() {
		...
		toggleChat.on("click", function (e) {
			e.preventDefault(), e.stopPropagation(), toggleChatSidebar()
		}), toggleChatBox.on("click", function (e) {
			e.preventDefault(), e.stopPropagation(), chatSidebar.toggleClass("conversation-open")
		}), $(".chat-input").keydown(function (e) {
			if (13 === e.keyCode) {
				e.preventDefault();
				var message = $(this).text();
				if ("" === message) return;
				$(".chat-conversation-content").append("<div class='chat-conversation-user them'><div class='chat-conversation-message'><p>" + $(this).text() + "</p></div></div>"), $(this).text("")
			}
		})
	}
	...
	function searchPredictToggle() {
		...
		val.length > 0 ? $(".search-predict").removeClass("hide") : $(".search-predict").addClass("hide")
	}
	...
	function headerSearch() {
		$(".search-input").focus(function () {
			...
			e.preventDefault(), e.stopPropagation(), isSearchOpen ? ($(".main-panel > .header").removeClass("search-open"), $(".search-form").addClass("hide"), $(".search-close-icon").addClass("hide"), $(".search-open-icon").removeClass("hide")) : ($(".main-panel > .header").addClass("search-open"), $(".search-form").removeClass("hide").find(".search-input")[0].focus(), $(".search-close-icon").removeClass("hide"), $(".search-open-icon").addClass("hide")), isSearchOpen = !isSearchOpen
		})
	}

	function quickLaunch() {
		$("[data-toggle=quick-launch]").on("click", function (e) {
			e.preventDefault(), $(".quick-launch-apps").is(":visible") ? $(".quick-launch-apps").addClass("hide").next().removeClass("hide") : $(".quick-launch-apps").removeClass("hide").next().addClass("hide")
		})
	}

	function scrollToTop() {
		$(".scroll-up").on("click", function (e) {
			return e.preventDefault(), e.stopPropagation(), $("html,body").stop().animate({
	...
	function smoothScroll() {
		$(".smooth-scroll").on("click", function (e) {
			if (e.preventDefault(), e.stopPropagation(), location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
				...
				if (target = target.length ? target : $("[name=" + this.hash.slice(1) + "]"), target.length) return $("html,body").stop().animate({
	...
	function rippleEffect() {
		$(".ripple").on("click", function (e) {
			...
			$ripple.css("height", $(this).height()), $ripple.css("width", $(this).height()), $div.css({
	...
	function cardControls() {
		$("[data-toggle=card-collapse]").on("click", function (e) {
			...
			body.is(":visible") ? (parent.addClass("card-collapsed"), body.slideUp(200)) : body.is(":visible") || (parent.removeClass("card-collapsed"), body.slideDown(200)), e.preventDefault(), e.stopPropagation()
		}), $("[data-toggle=card-refresh]").on("click", function (e) {
			var parent = $(this).parents(".card");
			parent.addClass("card-refreshing"), window.setTimeout(function () {
				parent.removeClass("card-refreshing")
			}, 3e3), e.preventDefault(), e.stopPropagation()
		}), $("[data-toggle=card-remove]").on("click", function (e) {
			var parent = $(this).parents(".card");
			parent.addClass("animated zoomOut"), parent.bind("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", function () {
				parent.remove()
	...
	function accordion() {
		...
		$(".accordion").length && (accordionBody.hide(), $(".accordion").each(function () {
			$(this).find(".accordion-body").first().show(), $(this).find(".accordion-container").first().addClass("active")
		})), accordionTitleTarget.on("click", function (e) {
			e.preventDefault(), e.stopPropagation();
			var thisParent = $(this).parent();
			return $(this).closest(".accordion").hasClass("accordion-toggle") || ($(this).closest(".accordion").find(".accordion-body").slideUp(), $(this).closest(".accordion").find(".accordion-container").removeClass("active")), "block" !== thisParent.next().css("display") ? (thisParent.next().slideDown(), thisParent.parent().addClass("active"), !1) : "block" === thisParent.next().css("display") ? (thisParent.next().slideUp(), thisParent.parent().removeClass("active"), !1) : !1
		})
	}

	function sidebarPanel() {
		$("[data-toggle=offscreen]").on("click", function (e) {
			e.preventDefault(), e.stopPropagation(), offscreenDirection = $(this).data("move") ? $(this).data("move") : "ltr", offscreenDirectionClass = "rtl" === offscreenDirection ? "move-right" : "move-left", rapidClickCheck || (rapidClickCheck = !0, toggleMenu())
		}), $(".main-panel").on("click", function (e) {
			var target = e.target;
			isOffscreenOpen && target !== $("[data-toggle=offscreen]") && toggleMenu()
			...
			var $this = $(this),
				...
				subMenu = $this.next();
			if (!subMenu.hasClass("sub-menu")) return void toggleMenu();
			if (!(app.hasClass("layout-small-menu") && parentLink.parent().hasClass("nav") && $(window).width() > 768)) return otherLinks.removeClass("open"), subMenu.is("ul") && 0 === subMenu.height() ? parentLink.addClass("open") : subMenu.is("ul") && 0 !== subMenu.height() && parentLink.removeClass("open"), "#" === $this.attr("href") && e.preventDefault(), updateScrollbars(), subMenu.is("ul") ? !1 : (e.stopPropagation(), !0)
	...
	function toggleMenu() {
		isChatOpen && toggleChatSidebar(), isOffscreenOpen ? (app.removeClass("move-left move-right"), setTimeout(function () {
			app.removeClass("offscreen")
		}, 150)) : app.addClass("offscreen " + offscreenDirectionClass), isOffscreenOpen = !isOffscreenOpen, rapidClickFix()
	}
	...
	function initScrollbars() {
		app.hasClass("layout-small-menu") || app.hasClass("layout-static-sidebar") || app.hasClass("layout-boxed") || psTarg.perfectScrollbar({
			wheelPropagation: !0,
			suppressScrollX: !0
		})
	}
	...
	function updateScrollbars() {
		psTarg.hasClass("ps-container") && !app.hasClass("layout-small-menu") && psTarg.perfectScrollbar("update")
	}

	function init() {
		smallMenu(), sidebarPanel(), chatPanel(), headerSearch(), quickLaunch(), scrollToTop(), smoothScroll(), activeState(), rippleEffect(), preloader(), scrollable(), cardControls(), accordion(), apps()
	}
	var offscreenDirection, offscreenDirectionClass, app = ($(window), $(".app")),
		isChatOpen = !1,
		isSearchOpen = !1,
		rapidClickCheck = !1,
		isOffscreenOpen = !1,
		psTarg = $(".no-touch .sidebar-panel");
	initScrollbars(), $(window).smartresize(function () {
		updateScrollbars()
	}), init()
}(jQuery);